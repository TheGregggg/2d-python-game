...
def savesWorld(saveWorld,saveWalls):
	with open('saves/world.save', 'wb') as f:
		# Pickle the 'data' dictionary using the highest protocol available.
		pickle.dump(saveWorld, f, pickle.HIGHEST_PROTOCOL)
	with open('saves/walls.save', 'wb') as f:
		# Pickle the 'data' dictionary using the highest protocol available.
		pickle.dump(saveWalls, f, pickle.HIGHEST_PROTOCOL) 
